...
export function BaseFooter({  
    ...
    const socialLinks = [
        { href: "mailto:abhinxv18@gmail.com", icon: <Mail className="w-3 h-3 sm:w-4 sm:h-4" /> },
        { href: "https://github.com/abhinxvz", icon: <Github className="w-3 h-3 sm:w-4 sm:h-4" /> },
        { href: "https://x.com/ishowr4ge", icon: <Twitter className="w-3 h-3 sm:w-4 sm:h-4" /> },
        { href: "https://leetcode.com/u/abhinxvz/", icon: <Code className="w-3 h-3 sm:w-4 sm:h-4" /> }
    ]
